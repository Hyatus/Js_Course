...
function buscarImagenes(){
    ...
    const key = '32815228-0a64ef61f62a8feda1fa723ef';
    ...
    imagenes.forEach(imagen =>{
        ...
        resultado.innerHTML += `
            <div class="w-1/2 md:w-1/3 lg:w-1/4 p-3 mb-4">
                <div class="bg-white">
                    <img src="${previewURL}" alt =${largeImageURL} class="w-full"/>
                    <div class="p-4">
                        <p class='font-bold'> <span class="font-light">Me gusta</span> ${likes}</p>
                        <p class='font-bold'> <span class="font-light">Views</span> ${views}</p>
                        <a 
                            href="${largeImageURL}" 
                            target='_blank' 
